namespace BettingGame.Framework.Abstraction.Clients.Betting
{
    ...
    public partial class ParticipantBetCommand : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static ParticipantBetCommand FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ParticipantBetCommand>(data);
        }
